...
| **Evolution curve** | The capability axis: E01 Reactive → E02 Task-Aware → E03 Context-Aware → E04 Personally Intelligent. Assessed by a human in a teardown, never computed from a spec. Unlike trust, it does not cascade. | [schemas/aux-evolution-curve.yaml](../schemas/aux-evolution-curve.yaml); applied in [repos/agent-ux-teardowns](../repos/agent-ux-teardowns) |
